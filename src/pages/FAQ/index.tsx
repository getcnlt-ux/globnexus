...
export default function FAQ() {
  ...
  return (
    <div className="pt-32 pb-20 px-6 max-w-4xl mx-auto">
      <h1 className="text-4xl md:text-7xl font-display font-bold mb-16 text-center tracking-tighter text-zinc-900 dark:text-white">{t('faq_page.title')}</h1>
    ...
    <div className="border border-black/5 dark:border-white/5 rounded-2xl overflow-hidden glass-panel">
      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            <div className="p-6 pt-0 text-zinc-600 dark:text-zinc-300 font-medium leading-relaxed">
              {answer}
            </div>
          </motion.div>
        )}
