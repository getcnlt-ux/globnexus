...
export default function Footer() {
  ...
  return (
    <footer className="bg-zinc-950 border-t border-white/5 pt-20 pb-10">
      ...
      <div className="max-w-7xl mx-auto px-6 mt-20 pt-10 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-zinc-600">
