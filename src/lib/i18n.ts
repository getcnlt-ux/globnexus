...
const resources = {
  ko: {
    translation: {
      ...
      home: {
        subtitle: '// GLOBAL NEXIS TOTAL CONTROL',
        titlePart1: 'BEYOND',
        titlePart2: 'GLOBAL',
        titlePart3: 'BY',
        titlePart4: 'INSIGHT',
        ...
        mfgSectionDesc: '단순한 소싱을 넘어 독자적인 제품 개발을 꿈꾸시나요? 글로벌 넥시스는 중국 현지 최고의 정밀 제조 네트워크를 통해 시제품 제작부터 OEM 대량 생산까지 모든 단계를 완벽하게 관리합니다.',
      ...
      about: {
        ...
        titlePart3: 'VISION &',
        titlePart4: 'REALITY',
        intro1: 'Global Nexis(글로벌 넥시스)는 단순한 물류 대행을 넘어, 전 세계 비즈니스의 국경을 허무는 혁신적인 가교 역할을 수행합니다.',
        ...
        philTitle: '날카로운 분석과\n빈틈없는 관리',
        philDesc: '물류는 단순히 물건을 옮기는 과정이 아닙니다. 정보의 흐름을 지배하고 리스크를 선제적으로 제어하는 것이 핵심입니다. 글로벌 넥시스는 인간의 통찰력과 디지털 관제 시스템을 결합하여 세상에 없던 물류 경험을 창조합니다.',
        ...
        controlCenter: '글로벌 넥시스 통합 관제 센터',
        card1Title: '글로벌 인프라',
      ...
      footer: {
        ...
        contact: 'Contact',
        admin: '관리자 접속',
        desc: '세계를 연결하는 글로벌 비즈니스의 가교. Global Nexis와 함께 국경 없는 물류와 구매의 혁신을 경험하세요.',
        sourcing: '구매 대행',
        certification: '인증 대행',
        services: '주요 서비스',
        b2b: 'B2B 솔루션',
      ...
      apply_page: {
        ...
        fields: {
          ...
          kakao: '카카오톡 ID (선택)',
          method: '선호하는 상담 방식',
          privacy: '개인정보 수집 및 이용 안내: 글로벌 넥시스는 원활한 상담을 위해 성함, 연락처, 이메일 정보를 수집합니다. 수집된 정보는 상담 목적 외 다른 용도로 사용되지 않으며, 상담 완료 후 지체 없이 파기됩니다.'
        },
        btns: {
          prev: '이전 단계',
          back: '뒤로 가기',
  ...
  en: {
    translation: {
      ...
      home: {
        ...
        mfgSectionDesc: 'Dreaming of developing your own unique products beyond simple sourcing? Global Nexis perfectly manages every stage from prototyping to OEM mass production through the best local precision manufacturing network in China.',
      ...
      about: {
        ...
        titlePart3: 'VISION &',
        titlePart4: 'REALITY',
        intro1: 'Global Nexis goes beyond simple logistics agency to serve as an innovative bridge that breaks down the borders of global business.',
        ...
        philDesc: 'Logistics is not just about moving things. It is about dominating the flow of information and preemptively controlling risks. Global Nexis combines human insight with digital control systems to create a logistics experience that never existed before.',
        ...
        controlCenter: 'Global Nexis Global Control Center',
      ...
      footer: {
        ...
        contact: 'Contact',
        admin: 'Admin Login',
        desc: 'The bridge for global business connecting the world. Experience innovation in borderless logistics and procurement with Global Nexis.',
      ...
      apply_page: {
        ...
        fields: {
          ...
          privacy: 'Personal Information Collection Notice: Global Nexis collects name, phone, and email for smooth consultation. Collected info is used only for consultation and destroyed immediately after completion.'
        },
        btns: {
          prev: 'Previous',
          back: 'Back',
  ...
  zh: {
    translation: {
      ...
      home: {
        ...
        mfgSectionDesc: '除了简单的采购，您是否梦想开发独特的自有产品？Global Nexis 通过中国当地顶尖的精细制造网络，完美管理从原型制作到 OEM 量产的每一个阶段。',
      ...
      about: {
        ...
        controlCenter: 'Global Nexis 全球控制中心',
        card1Title: '全球基础设施',
